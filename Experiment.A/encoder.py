...
def main(inwavfile, outmp3file, bitrate):
  ...
  while input_buffer.nprocessed_samples < input_buffer.nsamples:
    ...
    mnr_formatted = np.zeros((params.nch, N_SUBBANDS), dtype='float32')
    ...
    for ch in range(params.nch):
      ...
      subband_bit_allocation[ch,:],mnr_formatted[ch,:] = psycho.model1(input_buffer.audio[ch].ordered(), params,scfindices)
